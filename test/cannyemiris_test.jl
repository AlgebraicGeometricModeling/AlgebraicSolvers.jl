...
# With numeric coefficients
CE0, PM0 = CannyEmiris.Multihomogeneous(D0, N0,CannyEmiris.NumCoeff(F,X);verbose=false)
...
CE1, PM1 = CannyEmiris.Multihomogeneous(D0, N0, Coeff1;verbose=false)
...
CE2, PM2 = CannyEmiris.Zonotopes(A,H,CannyEmiris.NumCoeff(G,X);verbose=false)


# With symbolic coefficients
CE, PM = CannyEmiris.Zonotopes(A,H,Coeff1;verbose=false)
